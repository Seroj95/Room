...
onCreate(db);
    ...
    public void addCar(Cars cars){
        ...
        contentValues.put(Util.KEY_NAME,cars.getName());
        contentValues.put(Util.KEY_PRICE,cars.getPrice());
    ...
    public Cars getCar(int id){
        ...
        Util.KEY_NAME,Util.KEY_PRICE},Util.KEY_ID +"=?",new String[]{String.valueOf(id)},
                 null, null, null, null);
        if (cursor != null){
            cursor.moveToFirst();
        }
        Cars cars = new Cars (Integer.parseInt(cursor.getString(0)),
